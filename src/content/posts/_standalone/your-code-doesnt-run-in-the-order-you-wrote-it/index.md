---
title: "Your Code Doesn't Run in the Order You Wrote It"
...
_A note on this post: an earlier version lived here first, and it wasn't good. It explained the event loop the way most posts do, as a mechanism to memorize, and never touched the one question that makes the whole thing click: why any of it has to work that way. So I rewrote it from scratch._
